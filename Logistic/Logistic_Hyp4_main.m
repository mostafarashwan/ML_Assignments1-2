...
parameters=[cell2mat((training_data(:,1))) cell2mat((training_data(:,8))) cell2mat((training_data(:,10))) cell2mat((training_data(:,13))) ] ; %parameters from 4 to the 7
...
iterations=10000; %Number of iterations until reaching a best fit line
mse=[]; %MSEs
i=[]; %iterations
...
%% Iterations vs Mean Square Error for Linear regression
 ...
 testing_parameters=[cell2mat((testing_data(:,1))) cell2mat((testing_data(:,8))) cell2mat((testing_data(:,10))) cell2mat((testing_data(:,13)))];

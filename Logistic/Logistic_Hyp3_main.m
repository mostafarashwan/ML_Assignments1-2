...
parameters=[cell2mat((training_data(:,1))) cell2mat((training_data(:,5))) cell2mat((training_data(:,8)))] ; %parameters from 4 to the 7
...
%% Iterations vs Mean Square Error for Linear regression
 ...
 testing_parameters=[cell2mat((testing_data(:,1))) cell2mat((testing_data(:,5))) cell2mat((testing_data(:,8)))];

...
parameters=[cell2mat((training_data(:,6))) cell2mat((training_data(:,7))) cell2mat((training_data(:,11))) cell2mat((training_data(:,12))) cell2mat((training_data(:,15)))] ; %parameters 6, 7, 11, 12 and 15
...
%% Iterations vs Mean Square Error for Linear regression
 ...
 testing_parameters=[cell2mat((testing_data(:,6))) cell2mat((testing_data(:,7))) cell2mat((testing_data(:,11))) cell2mat((testing_data(:,12))) cell2mat((testing_data(:,15)))];
